...
MICCAI16_WEIGHTS_PATH = os.path.join(ROOT_DIR, "miccai16.h5")
...
class MiccaiDataset(utils.Dataset):
    ...
    def load_miccai_dataset(self, dataset_dir,subset):
        ...
        taille_train = int(0.6*nb_image)
        taille_val = int(0.2*nb_image)
        taille_test = nb_image - taille_train - taille_val
...
if __name__ == '__main__':
    ...
    if args.weights.lower() == "coco":
        ...
        # Find last trained weights
        weights_path = "/floyd/home/logs/miccai_20px_resnet101/mask_rcnn_miccai_0036.h5"
        flag=False
